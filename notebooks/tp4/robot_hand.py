...
class Robot:
    ...
    * visuals: the list of all the 'visual' 3D objects to render the robot, each element of the list being
    ...
    def createHand(self,rootId=0,prefix='',jointPlacement=None):
        ...
        capsr = 1*cm; capsl = W
        try:self.viewer.addCapsule('world/'+prefix+'palm2', 1*cm, W, color)
        except: pass
        ...
        try:self.viewer.addCapsule('world/'+prefix+'finger11', H, FL-2*H, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.5,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = FL-2*H
        try:self.viewer.addCapsule('world/'+prefix+'finger12', H, FL-2*H, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.3,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = 0.;
        try:self.viewer.addSphere('world/'+prefix+'finger13', capsr, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.5,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = FL-2*H
        try:self.viewer.addCapsule('world/'+prefix+'finger21', H, FL-2*H, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.5,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = FL-2*H
        try:self.viewer.addCapsule('world/'+prefix+'finger22', H, FL-2*H, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.3,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = 0.;
        try:self.viewer.addSphere('world/'+prefix+'finger23', H, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.5,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = FL-2*H
        try:self.viewer.addCapsule('world/'+prefix+'finger31', H, FL-2*H, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.5,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = FL-2*H
        try:self.viewer.addCapsule('world/'+prefix+'finger32', H, FL-2*H, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.3,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = 0.
        try:self.viewer.addSphere('world/'+prefix+'finger33', H, color)
        except: pass
        ...
        self.model.appendBodyToJoint(jointId,inertia(.5,[0,0,0]),se3.SE3.Identity())
        capsr = H; capsl = 2*cm
        try:self.viewer.addCapsule('world/'+prefix+'thumb1', H, 2*cm, color)
        except: pass
        ...
        capsr = H; capsl = FL-2*H
        try:self.viewer.addCapsule('world/'+prefix+'thumb2', H, FL-2*H, color)
        except: pass
